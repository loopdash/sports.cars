...
<!-- ============ HERO — carousel + search ============ -->
  <section class="c3-hero" data-c3-hero>
    <div class="c3-hero__slides">
      <div class="c3-hero__slide is-active"><img fetchpriority="high" decoding="async" src="<?php echo SC_URI; ?>/assets/img/hero/porsche-hybrid-wheel-dusk.avif" alt="A hybrid sports car wheel and rear haunch lit by low sun at dusk" /></div>
      <div class="c3-hero__slide"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/hero/corvette-stingray-city.jpg" alt="A grey Corvette Stingray convertible panning past a city storefront" /></div>
      <div class="c3-hero__slide"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/hero/acura-nsx-red.avif" alt="A red Acura NSX cornering on a tree-lined road" /></div>
      <div class="c3-hero__slide"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/hero/porsche-911-targa-coast.avif" alt="A sage green Porsche 911 Targa 4S on a coastal cliff road" /></div>
      <div class="c3-hero__slide"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/hero/porsche-911-gts-mountain.jpg" alt="A grey Porsche 911 GTS on a mountain road at golden hour" /></div>
      <div class="c3-hero__slide"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/hero/corvette-zr1-summit.avif" alt="A yellow Corvette ZR1 on a mountain road above the clouds" /></div>
      <div class="c3-hero__slide"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/hero/mustang-gt-mountain.avif" alt="A blue Ford Mustang GT parked on a mountain road" /></div>
      <div class="c3-hero__slide"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/hero/mustang-pair-underpass.avif" alt="A green and an orange Ford Mustang running side by side under an overpass" /></div>
      ...
      <div class="c3-explore" data-c3-explore>
        ...
        <div class="c3-preview">
          <div class="c3-frame c3-preview__frame"><span class="c3-frame__mark"></span>
            <img loading="lazy" decoding="async" class="c3-preview__img is-active" data-c3-pane="0" src="https://images.unsplash.com/photo-1544829099-b9a0c07fad1a?auto=format&fit=crop&w=1200&q=72" alt="Exotics" />
            <img loading="lazy" decoding="async" class="c3-preview__img" data-c3-pane="1" src="https://images.unsplash.com/photo-1614162692292-7ac56d7f7f1e?auto=format&fit=crop&w=1200&q=72" alt="Supercars" />
            <img loading="lazy" decoding="async" class="c3-preview__img" data-c3-pane="2" src="https://images.unsplash.com/photo-1580273916550-e323be2ae537?auto=format&fit=crop&w=1200&q=72" alt="Track Cars" />
            <img loading="lazy" decoding="async" class="c3-preview__img" data-c3-pane="3" src="https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=1200&q=72" alt="Classic Sports Cars" />
            <img loading="lazy" decoding="async" class="c3-preview__img" data-c3-pane="4" src="https://images.unsplash.com/photo-1583121274602-3e2820c69888?auto=format&fit=crop&w=1200&q=72" alt="Modern Performance" />
            <img loading="lazy" decoding="async" class="c3-preview__img" data-c3-pane="5" src="https://images.unsplash.com/photo-1600712242805-5f78671b24da?auto=format&fit=crop&w=1200&q=72" alt="Rare &amp; Collectible" />
  ...
  <section class="c3-section" id="inventory">
    <div class="c3__container c3__container--wide">
      ...
      <div class="c3-cars">
        <a href="<?php echo esc_url( home_url( '/listing/' ) ); ?>" class="c3-car">
          <div class="c3-frame c3-car__frame"><span class="c3-frame__mark"></span>
            <img loading="lazy" decoding="async" class="c3-car__img" src="https://images.unsplash.com/photo-1583121274602-3e2820c69888?auto=format&fit=crop&w=1400&q=75" alt="2015 Ferrari LaFerrari" />
        ...
        <a href="<?php echo esc_url( home_url( '/listing/' ) ); ?>" class="c3-car">
          <div class="c3-frame c3-car__frame"><span class="c3-frame__mark"></span>
            <img loading="lazy" decoding="async" class="c3-car__img" src="https://images.unsplash.com/photo-1503736334956-4c8f8e92946d?auto=format&fit=crop&w=1400&q=75" alt="2015 Ferrari 458 Speciale" />
            <button type="button" class="c3-car__fav" aria-label="Save this car"><svg viewBox="0 0 24 24"><path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.6l-1-1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 0 0 0-7.8z"/></svg></button>
          </div>
          <div class="c3-car__body">
        ...
        <a href="<?php echo esc_url( home_url( '/listing/' ) ); ?>" class="c3-car">
          <div class="c3-frame c3-car__frame"><span class="c3-frame__mark"></span>
            <img loading="lazy" decoding="async" class="c3-car__img" src="https://images.unsplash.com/photo-1580273916550-e323be2ae537?auto=format&fit=crop&w=1400&q=75" alt="2019 BMW M4 Competition" />
            <button type="button" class="c3-car__fav" aria-label="Save this car"><svg viewBox="0 0 24 24"><path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.6l-1-1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 0 0 0-7.8z"/></svg></button>
          </div>
          <div class="c3-car__body">
        ...
        <a href="<?php echo esc_url( home_url( '/listing/' ) ); ?>" class="c3-car">
          <div class="c3-frame c3-car__frame"><span class="c3-frame__mark"></span>
            <img loading="lazy" decoding="async" class="c3-car__img" src="https://images.unsplash.com/photo-1544829099-b9a0c07fad1a?auto=format&fit=crop&w=1400&q=75" alt="2019 Lamborghini Huracán" />
            <button type="button" class="c3-car__fav" aria-label="Save this car"><svg viewBox="0 0 24 24"><path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.6l-1-1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 0 0 0-7.8z"/></svg></button>
          </div>
          <div class="c3-car__body">
      ...
      <div style="margin-top:92px">
        ...
        <div class="c3-brands">
          <a href="<?php echo esc_url( home_url( '/search/' ) ); ?>" class="c3-brand"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/brands/ferrari.png" alt="Ferrari" /><span class="c3-brand__count">View listings</span></a>
          <a href="<?php echo esc_url( home_url( '/search/' ) ); ?>" class="c3-brand"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/brands/porsche.png" alt="Porsche" /><span class="c3-brand__count">View listings</span></a>
          <a href="<?php echo esc_url( home_url( '/search/' ) ); ?>" class="c3-brand"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/brands/lamborghini.png" alt="Lamborghini" /><span class="c3-brand__count">View listings</span></a>
          <a href="<?php echo esc_url( home_url( '/search/' ) ); ?>" class="c3-brand"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/brands/mclaren.png" alt="McLaren" /><span class="c3-brand__count">View listings</span></a>
          <a href="<?php echo esc_url( home_url( '/search/' ) ); ?>" class="c3-brand"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/brands/aston-martin.png" alt="Aston Martin" /><span class="c3-brand__count">View listings</span></a>
          <a href="<?php echo esc_url( home_url( '/search/' ) ); ?>" class="c3-brand"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/brands/bugatti.png" alt="Bugatti" /><span class="c3-brand__count">View listings</span></a>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="c3-posts">
        <a href="<?php echo esc_url( home_url( '/article/' ) ); ?>" class="c3-post">
          <div class="c3-frame c3-post__frame"><span class="c3-frame__mark"></span>
            <img loading="lazy" decoding="async" class="c3-post__img" src="https://images.unsplash.com/photo-1580273916550-e323be2ae537?auto=format&fit=crop&w=1000&q=70" alt="" />
        ...
        <a href="<?php echo esc_url( home_url( '/article/' ) ); ?>" class="c3-post">
          <div class="c3-frame c3-post__frame"><span class="c3-frame__mark"></span>
            <img loading="lazy" decoding="async" class="c3-post__img" src="https://images.unsplash.com/photo-1503736334956-4c8f8e92946d?auto=format&fit=crop&w=1000&q=70" alt="" />
            <span class="c3-post__sweep"></span>
          </div>
        ...
        <a href="<?php echo esc_url( home_url( '/article/' ) ); ?>" class="c3-post">
          <div class="c3-frame c3-post__frame"><span class="c3-frame__mark"></span>
            <img loading="lazy" decoding="async" class="c3-post__img" src="https://images.unsplash.com/photo-1600712242805-5f78671b24da?auto=format&fit=crop&w=1000&q=70" alt="" />
            <span class="c3-post__sweep"></span>
          </div>
  ...
  <section class="c3-section c3-trust" id="trust">
    <div class="c3__container c3-trust__grid">
      <div class="c3-frame c3-frame--light c3-trust__frame"><span class="c3-frame__mark"></span>
        <img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/hero/monaco-bugatti.jpg" alt="A Bugatti on the Monaco waterfront" />
      </div>
      <div>
  ...
  <section class="c3-cta">
    <div class="c3-cta__media"><img loading="lazy" decoding="async" src="<?php echo SC_URI; ?>/assets/img/hero/monaco-sunset.jpg" alt="" /></div>
